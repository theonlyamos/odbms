...
class User(Model):
    ...
    def create_table():
        ...
        return User.Database.db.query(f'''
    ...
    def save(self):
        ...
        if User.Database.dbms == 'mongodb':
            data["created_at"] = self.created_at
            data["updated_at"] = self.updated_at

        return User.Database.db.insert(User.TABLE_NAME, data)
    ...
    def reset_password(self, new_password: str):
        ...
        User.Database.db.update_one(User.TABLE_NAME, User.normalise({'id': self.id}, 'params'), {'password': new_password})
    ...
    def get_by_email(cls, email: str):
        ...
        '''
        user = User.Database.db.find_one(User.TABLE_NAME, {"email": email})
